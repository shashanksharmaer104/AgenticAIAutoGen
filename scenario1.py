...
async def main():
    ...
    playwright_workbench = McpWorkbench(playwright_params)
    ...
    async with jira_workbench as jira_wb, playwright_workbench as playwright_wb:
        ...
        team = RoundRobinGroupChat(
            participants=[automation_analyst, bug_analyst],
        ...
        await Console(team.run_stream(task="BugAnalyst: \n"
                                       ...
                                       "Once ready, automate this flow using Playwright MCP and execute it.\n"
                                        'NOTE: First gather all info with BugAnalyst and then for automation with AutomationAgent.'))
